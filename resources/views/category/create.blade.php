...
<div class="h-screen w-screen flex">
    <div class="h-screen w-100 max-[926px]:w-40 bg-red-800 z-10 p-3">
        <form action="{{route('category.store')}}" method="POST">
            ...
            <input class="mb-3 px-2 py-1.5
                   ...
                   focus:ring-1
                   focus:ring-sky-500
                   focus:invalid:border-red-500 focus:invalid:ring-red-500" name="name">
            <button class="px-4 py-1.5 rounded-md shadow-lg bg-gradient-to-r from-green-600 to-green-700 font-medium text-gray-100 block transition duration-300">Submit</button>
        </form>
    </div>
